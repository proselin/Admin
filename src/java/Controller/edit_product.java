...
public class edit_product extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String pSale_Quantity = request.getParameter("psale");
        String pCurrent_Quantity = request.getParameter("pcurrent");
        ...
        pro.update_product(pID, pName, Float.NaN, pDes, 0, 0, pBrand, pYear, pIncense, pMadeIn, pStatus);
