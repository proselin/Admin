...
public class Product {
    ...
    public String toString() {
        return "Product{" + "pID=" + pID + ", pName=" + pName + ", pPrice=" + pPrice + ", pDes=" + pDes + ", pSale_Quantity=" + pSale_Quantity + ", pCurrent_Quantity=" + pCurrent_Quantity + ", pYear=" + pYear + ", pGet_Date=" + pGet_Date + ", pBrand=" + pBrand + ", pGender=" + pGender + ", pIncense=" + pIncense + ", pMadeIn=" + pMadeIn + ", pRate_Count=" + pRate_Count + ", pStatus=" + pStatus + ", cateID=" + cateID + ", cateName=" + cateName + ", imgs=" + imgs + ", take=" + take + '}';
    }
